...
namespace HurricaneVR.Framework.Weapons
{
    ...
    public class HVRRayCastGun : HVRDamageProvider
    {
        ...
        protected virtual void OnAmmoGrabbed(HVRGrabberBase grabber, HVRGrabbable grabbable)
        {
            ...
            Debug.Log("grabbable" + grabbable.name);
            if (!ammo)
            {
        ...
        public virtual void ReleaseAmmo()
        {
            ...
            if (ammoGrabbable)
            {
                ...
                if (!releasedAmmo.HasAmmo && releasedAmmo.DestroyIfEmpty || releasedAmmo.destroyOnEject)
                {
        ...
        protected virtual void FirePhysicBullet(Vector3 direction)
        {
            ...
            Debug.Log("bullet name " + bullet.name);
